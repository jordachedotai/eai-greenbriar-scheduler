...
Draft email to the partners. "Before the portco ever sees a date, the partners sign off. That's Peggy's rule." Approve and send. Waiting on the partners. Press Demo: simulate partner replies. Five yeses land in the activity log.

## Beat 3: company picks (30 seconds)
Draft email to Tom Haggerty, the AIT CEO. Approve and send. Waiting on the portco. Simulate company picks. Quarter chips fill with the chosen dates.
