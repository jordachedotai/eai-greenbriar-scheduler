...
For Phase 5 task 51: lift the values from these files, do not eyeball a screenshot. Fonts are Source Serif 4 (titles, big numbers) and Source Sans 3 (everything else), both on Google Fonts. Base body 16px, nothing under 12px.
